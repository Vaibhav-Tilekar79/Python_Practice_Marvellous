'''
Que -> Write a program which contains one class named as BookStore.
...
E.g -> Obj1 = BookStore(“Linux System Programming”, “Robert Love”)
...
class BookStore:
	...
	def Display(self):
		...
		print(self.name1,"by",self.auth,"and No of books : ",BookStore.NoOfBooks)

def main():
	name1 = input("Enter the name of book : ")
	auth = input("Enter the name of author : ")

	Obj1 = BookStore(name1,auth)
	Obj1.Display()

	name2 = input("Enter the name of book : ")
	auth2 = input("Enter the name of author : ")

	Obj2 = BookStore(name2,auth2)
	Obj2.Display()
